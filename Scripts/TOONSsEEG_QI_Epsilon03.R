...
N <- 124  # number of patients for whom to simulate data
...
terms(lda_model, 5)  # Show 5 terms for each topic

# Extract the topic-term probabilities
topic_term_probs <- posterior(lda_model)$terms
print(topic_term_probs)

# Posterior distributions of topics for each document
